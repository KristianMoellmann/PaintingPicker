...
from custom_data import ScaleDataset, EmbeddedScaleDataset
...
class ScaleNet(nn.Module):
    ...
    def __init__(self, input_size: int=512) -> None:
        ...
        self.l1 = nn.Linear(input_size, 3)  # Change 512 to the number of features extracted by the feature extractor
        self.r = nn.ReLU()
